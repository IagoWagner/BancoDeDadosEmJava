...
String sql = "insert into usuario (usuario,senha) values ('"+usuario.
...
statement.execute();
    ...
    public void insertOrUpadate(Usuario usuario) throws SQLException{
    ...
    private ArrayList<Usuario> pesquisa(PreparedStatement statement)
            throws SQLException {
    ...
    public boolean existePorUsuarioESenha(Usuario usuario) throws SQLException {
       String sql = "select * from usuario where usuario = '"+usuario.
               getUsuario()+"' and senha = '"+usuario.getSenha()+"' ";
       PreparedStatement statement = connection.prepareStatement(sql);
       statement.execute();
